  ...
  return (
    <section className="relative px-6 sm:px-12 py-24 sm:py-32 max-w-[640px] mx-auto text-center">
      <Reveal variant="fade-up">
        ...
        <h2 className="text-[36px] sm:text-[44px] font-bold tracking-[-0.03em] text-[var(--text-primary)] mb-4">
          Free. All of it. No catch.
        </h2>
        <p className="text-[15px] text-black/55 dark:text-white/55 leading-relaxed max-w-[480px] mx-auto mb-12">
      ...
      <Reveal variant="scale-in">
        <div className="max-w-[400px] mx-auto text-left bg-black/[0.03] dark:bg-white/[0.03] border border-black/[0.08] dark:border-white/[0.08] rounded-[16px] p-6 sm:p-8">
          <div className="flex items-baseline gap-2 mb-4">
            ...
            <span className="text-[14px] text-black/40 dark:text-white/40">/forever</span>
          </div>
          ...
          <p className="font-mono text-[12px] text-black/40 dark:text-white/40">total: $0.00</p>
        </div>
      </Reveal>

      <Reveal variant="fade-up" delay={120}>
        <p className="mt-6 text-[12px] text-black/30 dark:text-white/30 max-w-[420px] mx-auto leading-relaxed">
